    ...
    public class daoUsuario:BaseDatos
    {
        ...
        public void dao_Actualizar_Usuario(Entities_ObjectFinder.Usuario.entUsuario Usuario)
        {
            try
            {
                ...
                {                
                    dbDatos.AddInParameter(cmd, "PTELEFONO", DbType.String, Usuario.telefono);
                    dbDatos.AddInParameter(cmd, "PCELULAR", DbType.String, Usuario.celular);
                    dbDatos.AddInParameter(cmd, "PCLAVE", DbType.String, Usuario.clave);
                    dbDatos.AddInParameter(cmd, "pid_usuario", DbType.String, Usuario.idUsuario);
                    ...
                    using(IDataReader dbReader = dbDatos.ExecuteReader(cmd))
                    {
                        while(dbReader.Read())
                        {
                            ...
                            if(dbReader["TELEFONO"] != null)
                                objUsuario.telefono = dbReader["TELEFONO"].ToString();
                            if(dbReader["CELULAR"] != null)
                                objUsuario.celular = dbReader["CELULAR"].ToString();
